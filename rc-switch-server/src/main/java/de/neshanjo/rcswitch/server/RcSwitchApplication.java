...
import de.neshanjo.rcswitch.server.services.LogService;
import de.neshanjo.rcswitch.server.services.LogServiceImpl;
    ...
    public RcSwitchApplication() {
        ...
        register(new AbstractBinder() {
            ...
            public void configure() {
                bind(LogServiceImpl.class).to(LogService.class).in(Singleton.class);
                if (testMode) {
